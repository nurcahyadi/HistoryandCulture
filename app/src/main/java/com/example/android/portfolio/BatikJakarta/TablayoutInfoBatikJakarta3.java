...
public class TablayoutInfoBatikJakarta3 extends AppCompatActivity {
...
//        });
        ...
        file_maps.put("Batik Rasamala", R.mipmap.batikrasamala);
        file_maps.put("Batik Rasamala.", R.mipmap.batikrasamala);
...
//            textView.setText(getString(R.string.section_format, getArguments().getInt(ARG_SECTION_NUMBER)));
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            switch (position) {
                case 0:
                    FragmentInfoBatikJakarta3 tab1 = new FragmentInfoBatikJakarta3();
                    return tab1;
                case 1:
                    FragmentInfoBatikmapsJakarta3 tab2 = new FragmentInfoBatikmapsJakarta3();
                    return tab2;
