...
public class TablayoutInfoBatikBandung3 extends AppCompatActivity {
...
//        });
        ...
        file_maps.put("Batik Jalak Harupat", R.mipmap.batikjalakharupat);
        file_maps.put("Batik Jalak Harupat.", R.mipmap.batikjalakharupat);
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position) {
                case 0:
                    FragmentInfoBatikBandung3 tab1 = new FragmentInfoBatikBandung3();
                    return tab1;
                case 1:
                    FragmentInfoBatikmapsBandung3 tab2 = new FragmentInfoBatikmapsBandung3();
                    return tab2;
