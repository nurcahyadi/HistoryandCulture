...
public class TablayoutInfoBatikJakarta4 extends AppCompatActivity {
...
//        });
        ...
        file_maps.put("Batik Salakanegara", R.mipmap.batiksalakanegara);
        file_maps.put("Batik Salakanegara.", R.mipmap.batiksalakanegara);
...
//            textView.setText(getString(R.string.section_format, getArguments().getInt(ARG_SECTION_NUMBER)));
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            switch (position) {
                case 0:
                    FragmentInfoBatikJakarta4 tab1 = new FragmentInfoBatikJakarta4();
                    return tab1;
                case 1:
                    FragmentInfoBatikmapsJakarta4 tab2 = new FragmentInfoBatikmapsJakarta4();
                    return tab2;
