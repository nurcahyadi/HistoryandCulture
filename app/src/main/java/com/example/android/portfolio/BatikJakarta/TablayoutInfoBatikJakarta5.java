...
public class TablayoutInfoBatikJakarta5 extends AppCompatActivity {
...
//        });
        ...
        file_maps.put("Batik Ondel-ondel", R.mipmap.batikondelondel);
        file_maps.put("Batik Ondel-ondel.", R.mipmap.batikondelondel);
...
//            textView.setText(getString(R.string.section_format, getArguments().getInt(ARG_SECTION_NUMBER)));
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            switch (position) {
                case 0:
                    FragmentInfoBatikJakarta5 tab1 = new FragmentInfoBatikJakarta5();
                    return tab1;
                case 1:
                    FragmentInfoBatikmapsJakarta5 tab2 = new FragmentInfoBatikmapsJakarta5();
                    return tab2;
