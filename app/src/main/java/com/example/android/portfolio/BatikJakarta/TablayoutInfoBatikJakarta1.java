...
public class TablayoutInfoBatikJakarta1 extends AppCompatActivity {
...
//        });
        ...
        file_maps.put("Batik Ciliwung", R.mipmap.batikciliwung);
        file_maps.put("Batik Ciliwung.", R.mipmap.batikciliwung);
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position) {
                case 0:
                    FragmentInfoBatikJakarta1 tab1 = new FragmentInfoBatikJakarta1();
                    return tab1;
                case 1:
                    FragmentInfoBatikmapsJakarta1 tab2 = new FragmentInfoBatikmapsJakarta1();
                    return tab2;
