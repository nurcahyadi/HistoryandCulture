...
public class TablayoutInfoBatikSurabaya2 extends AppCompatActivity {
...
//        });
        ...
        file_maps.put("Batik Sura dan Baya", R.mipmap.batiksuradanbaya);
        file_maps.put("Batik Sura dan Baya.", R.mipmap.batiksuradanbaya);
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position) {
                case 0:
                    FragmentInfoBatikSurabaya2 tab1 = new FragmentInfoBatikSurabaya2();
                    return tab1;
                case 1:
                    FragmentInfoBatikmapsSurabaya2 tab2 = new FragmentInfoBatikmapsSurabaya2();
                    return tab2;
