...
public class TablayoutInfoBatikBandung2 extends AppCompatActivity {
...
//        });
        ...
        file_maps.put("Batik Boscha Perkasa", R.mipmap.batikboschaperkasa);
        file_maps.put("Batik Boscha Perkasa.", R.mipmap.batikboschaperkasa);
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position) {
                case 0:
                    FragmentInfoBatikBandung2 tab1 = new FragmentInfoBatikBandung2();
                    return tab1;
                case 1:
                    FragmentInfoBatikmapsBandung2 tab2 = new FragmentInfoBatikmapsBandung2();
                    return tab2;
