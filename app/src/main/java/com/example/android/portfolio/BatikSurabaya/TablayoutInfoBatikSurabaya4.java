...
public class TablayoutInfoBatikSurabaya4 extends AppCompatActivity {
...
//        });
        ...
        file_maps.put("Batik Semanggi", R.mipmap.batiksemanggi);
        file_maps.put("Batik Semanggi.", R.mipmap.batiksemanggi);
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position) {
                case 0:
                    FragmentInfoBatikSurabaya4 tab1 = new FragmentInfoBatikSurabaya4();
                    return tab1;
                case 1:
                    FragmentInfoBatikmapsSurabaya4 tab2 = new FragmentInfoBatikmapsSurabaya4();
                    return tab2;
