...
public class TablayoutInfoBatikJakarta2 extends AppCompatActivity {
...
//        });
        ...
        file_maps.put("Batik Nusa Kelapa", R.mipmap.batiknusakelapa);
        file_maps.put("Batik Nusa Kelapa.", R.mipmap.batiknusakelapa);
...
//            textView.setText(getString(R.string.section_format, getArguments().getInt(ARG_SECTION_NUMBER)));
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            switch (position) {
                case 0:
                    FragmentInfoBatikJakarta2 tab1 = new FragmentInfoBatikJakarta2();
                    return tab1;
                case 1:
                    FragmentInfoBatikmapsJakarta2 tab2 = new FragmentInfoBatikmapsJakarta2();
                    return tab2;
